         ...
         class student extends JFrame implements ActionListener
 {
        ...
        [3].setText("char");
         ...
         if(current==1)
         {
         l.setText("Que2: Which class is available to all the class automatic ally?");
        ...
        [3].setText("lang");
         ...
         jb[0].setText("Utek");jb[1].setText("Aptech");jb[2].setText("SSS IT")
        ;jb[3].setText("jtek");
         }
         if(current==5)
         {
         ...
         if(current==7)
         {
         l.setText("Que8: which one among these is not a function of Obj ect class?");
